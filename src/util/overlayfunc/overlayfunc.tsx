...
const useActionList = (experienceData: { initializationData: { actionList: any; }; }) => {
    ...
    const addActionToList = ([path,input,assetID]: [string,string,string],hookinput: Array<[string,string,string]>,functioninput:Dispatch<SetStateAction<Array<[string,string,string]>>>) => {
        hookinput.push([path,input,assetID]);
        functioninput([...actionList])
    }
    
    const removeActionFromList = (index: number,hookinput: Array<[string,string,string]>,functioninput: Dispatch<SetStateAction<Array<[string,string,string]>>>) => {
    ...
    return {actionList, setActionList, removeActionFromList, addActionToList, handleOnDragEnd}
}
